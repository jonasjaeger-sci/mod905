...
def plot_potential(settings, axi):
    ...
    axi.set_ylim((-1.0, 1.0))


def plot_ensemble(settings, dirname, axi, axj, maxlines=100, maxorder=None):
    ...
    for traj in trajload:
        ...
        line2, = axj.plot(order, lw=3, alpha=0.9, marker='o')
    ...
    for i, line in enumerate(all_lines):
        ...
        all_lines2[i].set_color(colors[i])
...
if __name__ == '__main__':
    ...
    plot_ensemble(sim_settings, ens, ax1, ax2, maxorder=None)
    plt.show()
