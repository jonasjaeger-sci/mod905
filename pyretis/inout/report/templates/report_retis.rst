...
The initial flux is (unit: 1/@{{ text['flux-unit'] }}@)

.. admonition:: Initial flux

   :math:`f_{A} = @{{ numbers['flux'] }}@  \pm  @{{ numbers['flux-err'] }}@ \%`

The initial flux is (unit: 1/@{{ text['fluxc-unit'] }}@)

.. admonition:: Initial flux

   :math:`f_{A} = @{{ numbers['fluxc'] }}@  \pm  @{{ numbers['fluxc-err'] }}@ \%`
