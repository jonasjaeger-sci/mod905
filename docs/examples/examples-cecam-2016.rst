...
A single particle in a 1D potential
===================================

This is a short user guide for running the 1D potential
example with the RETIS algorithm for the CECAM workshop.
...
.. figure:: ../img/examples/thumbnails/tis-1d-pot.png
    ...
    is reactive (giving a transition), while the other is nonreactive.

The script for running a RETIS simulation can be found at `<http://pyretis.org/examples/retis_movie.py>`_.
